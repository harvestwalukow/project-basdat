      ...
      <form action="{{ route('admin.staff.store') }}" method="POST">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="col-span-2">
            ...
            <input type="text" name="nama_lengkap" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          </div>
          <div>
            <label class="block text-sm font-semibold text-gray-800 mb-1">Email</label>
            <input type="email" name="email" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          </div>
          <div>
            <label class="block text-sm font-semibold text-gray-800 mb-1">No. Telepon</label>
            <input type="text" name="no_telepon" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          </div>
          <div class="col-span-2">
            <label class="block text-sm font-semibold text-gray-800 mb-1">Password</label>
            <input type="password" name="password" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          </div>
          <div class="col-span-2">
            <label class="block text-sm font-semibold text-gray-800 mb-1">Spesialisasi</label>
            <select name="specialization" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          ...
          <div class="col-span-2">
            ...
            <textarea name="alamat" required rows="3" class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500"></textarea>
          </div>
        </div>
    ...
    <div class="relative top-20 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
      ...
      <form id="editStaffForm" method="POST">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div class="col-span-2">
            <label class="block text-sm font-semibold text-gray-800 mb-1">Nama Lengkap</label>
            <input type="text" id="edit_nama_lengkap" name="nama_lengkap" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          </div>
          <div>
            <label class="block text-sm font-semibold text-gray-800 mb-1">Email</label>
            <input type="email" id="edit_email" name="email" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          </div>
          <div>
            <label class="block text-sm font-semibold text-gray-800 mb-1">No. Telepon</label>
            <input type="text" id="edit_no_telepon" name="no_telepon" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          </div>
          <div class="col-span-2">
            <label class="block text-sm font-semibold text-gray-800 mb-1">Password (Kosongkan jika tidak diubah)</label>
            <input type="password" id="edit_password" name="password" class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
          </div>
          <div class="col-span-2">
            <label class="block text-sm font-semibold text-gray-800 mb-1">Spesialisasi</label>
            <select id="edit_specialization" name="specialization" required class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500">
              <option value="groomer">Groomer</option>
              <option value="handler">Handler</option>
              <option value="trainer">Trainer</option>
            </select>
          ...
          <div class="col-span-2">
            <label class="block text-sm font-semibold text-gray-800 mb-1">Alamat</label>
            <textarea id="edit_alamat" name="alamat" required rows="3" class="mt-1 block w-full rounded-md border-2 border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500"></textarea>
          </div>
        </div>
        <div class="mt-6 flex justify-end gap-3">
