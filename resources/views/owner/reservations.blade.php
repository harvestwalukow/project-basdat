  ...
  <div class="bg-white rounded-lg shadow">
    ...
    <div class="p-6 space-y-4" id="reservationsList">
      @if ($tab === 'semua')
          ...
          <div class="flex flex-col md:flex-row justify-between gap-4">
            <div class="flex-1 space-y-3">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h3 class="font-semibold owner-name">Sarah Johnson</h3>
                  <p class="text-sm text-gray-500 phone">081234567890</p>
                  <p class="text-sm"><span class="font-medium">Hewan:</span> <span class="pet-name">Buddy (Golden Retriever)</span></p>
                </div>
                <div>
        ...
        {{-- Card Reservasi 2 --}}
        {{-- ... dst data dummy kamu tetap sama persis --}}
